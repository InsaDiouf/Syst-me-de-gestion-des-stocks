            ...
            <div class="modal-body">
                <div class="form-group row text-left mb-2">
                    <div class="col-sm-12 text-center">
                        <h3 class="py-0">TOTAL GÉNÉRAL</h3>
                ...
                <div class="col-sm-12 mb-2">
                    <div class="input-group mb-2">
                        ...
                        <input class="form-control text-right" id="txtNumber" onkeypress="return isNumberKey(event)" type="text" name="cash" placeholder="ENTRER ARGENT" required>
                    </div>
                </div>
            </div>
