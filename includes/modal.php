...
$result = mysqli_query($db, $sqlforjob) or die ("Mauvais SQL : $sqlforjob");

$job = "<select class='form-control' name='jobs' required>
        <option value='' disabled selected hidden>Sélectionner un emploi</option>";
...
<!-- fin de Sélection d'employé et script -->
